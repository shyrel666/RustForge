...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::create_assessment_mission,
            commands::list_assessment_missions,
            commands::get_assessment_mission_detail,
            commands::preview_assessment_mission_context,
            commands::confirm_assessment_mission_context,
            commands::attach_assessment_mission_resource,
            commands::import_assessment_mission_openapi,
            commands::pick_assessment_openapi_file,
            commands::send_assessment_mission_message,
            commands::decide_assessment_action,
            commands::get_assessment_action_detail,
            commands::set_assessment_tool_permission,
            commands::create_assessment_mission_handoff,
            commands::link_assessment_mission_handoff_replay,
            commands::get_replay_session_assessment_handoff,
            commands::start_assessment_mission,
            commands::stop_assessment_mission,
            commands::build_report,
            commands::build_assessment_mission_report,
            commands::export_report,
            commands::export_assessment_mission_report,
